...
어플리케이션 개발 초기, 컨트롤러가 무엇인지 어떻게 사용하는 것인지, 디렉토리 구조를 어떻게 가져가야하는지에 대해 연구하여 팀원들에게 개발 환경을 제공했습니다.
팀원 중에는 정년이 다가온 어르신도 계셨고, 출석률이 점차 낮아지더니 이틀에 한 번 꼴로 오지 않는 팀원도 생겼습니다. 이런 다양한 환경에 놓인 사람들을 한데 뭉쳐 일관된 코드 스타일을 유지하는 것이 제  1 안건이었고, 코드에 대한 이해도가 낮은 팀원을 어떻게든 같은 궤도에서 프로젝트를 진행하도록 만드는게 제 2 안건이었습니다.
...
![](image/Pasted%20image%2020240223034937.png)

![](image/Pasted%20image%2020240223035032.png)
...
![](image/Pasted%20image%2020240223035732.png)

##### 피그마


![](image/Pasted%20image%2020240223040454.png)

그림판, 포토샵, 카카오 오븐, 피그마등 다양한 툴을 시도해보았고 관련 강의 등을 실습해보며 연습했습니다.
##### 프로토타입 디자인

![](image/KakaoTalk_20240223_041740164.jpg)
##### 초기 디자인

![](image/Pasted%20image%2020240223040610.png)

##### 중간 시점 디자인

![](image/Pasted%20image%2020240223040704.png)


##### 최종 디자인

![](image/Pasted%20image%2020240223040831.png)

**계속되는 리팩토링**

![](image/Pasted%20image%2020240223042250.png)

또한 위에서 언급했던 코드의 일관성 문제는 디자인에서도 나타났습니다.
이에 팀원들이 일관성있는 작업을 할 수 있도록 레이아웃을 만들어 공유했습니다.

![](image/Pasted%20image%2020240223042440.png)
...
그러나 실시간으로 데이터를 주고 받는다는 매력을 포기할 수 없었고 WearVillage에 웹소켓을 사용해 실시간 채팅을 구현하였습니다.
...
그 과정에서 서버에 대한 이해와 리눅스 환경에 익숙해졌고, Vim이나 Putty, FileZilla등 개발에 용이한 툴의 사용법도 어플리케이션 하나를 혼자 배포할 수 있게끔 공부했습니다.
...
![](image/Pasted%20image%2020240223045734.png)
...
![](image/제목%20없는%20동영상%20-%20Clipchamp로%20제작.gif)
...
![](image/Pasted%20image%2020240223050357.png)
...
![](image/Pasted%20image%2020240223051331.png)

![](image/Pasted%20image%2020240223051457.png)
